...
export default function PerlsteinLandingPage() {
  return <main className={styles.page}>
    ...
    <section className={styles.finalCta}><div><span>לפני שחותמים, בודקים.</span><h2>בואו נבנה את התמונה שלכם.</h2></div><div className={styles.actions}><Link className={styles.darkButton} href="/check?source=perlstein">לשאלון ההתאמה <ArrowLeft /></Link><a className={styles.outlineButton} href="tel:0533140442"><Phone /> 053-314-0442</a></div></section>
