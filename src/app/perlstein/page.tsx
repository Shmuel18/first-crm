  ...
  return <main className={styles.page}>
    ...
    <section id="content" tabIndex={-1} className={styles.hero}>
      ...
      <div className={styles.heroCopy}><span className={styles.eyebrow}><Sparkles size={14} /> ליווי אישי, מקצועי וברור</span>
        ...
        <div className={styles.actions}><Link className={styles.primary} href="/check?source=perlstein">לשאלון ההתאמה <ArrowLeft size={19} /></Link><a className={styles.secondary} href="https://wa.me/972533140442"><MessageCircle size={18} /> שיחה ב־WhatsApp</a></div>
    ...
    <section className={styles.finalCta}><div data-reveal=""><span>לפני שחותמים, בודקים.</span><h2>בואו נבנה את התמונה שלכם.</h2></div><div className={styles.actions} data-reveal=""><Link className={styles.darkButton} href="/check?source=perlstein">לשאלון ההתאמה <ArrowLeft /></Link><a className={styles.outlineButton} href="tel:0533140442"><Phone /> 053-314-0442</a></div></section>
