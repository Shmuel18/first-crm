/**
 * Loading skeleton for /cases/[id]. Mirrors the case-detail layout:
 * sticky action bar strip + 2-col grid of pulsing block placeholders.
 * Replaces the generic (app)/loading.tsx during navigation into a case.
 */
export default function CaseDetailLoading() {
  return (
    <div className="space-y-5 -mt-6 animate-pulse" aria-hidden>
      {/* Action bar shell */}
