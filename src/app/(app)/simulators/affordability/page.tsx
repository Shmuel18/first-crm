...
import { AffordabilityCalculator } from '@/features/simulators/components/affordability-calculator';
import { SimulatorToolsNav } from '@/features/simulators/components/simulator-tools-nav';
import { userHasPermission } from '@/lib/auth/permissions';

export default async function AffordabilitySimulatorPage() {
  if (!(await userHasPermission('view_simulators'))) redirect('/cases');
  const t = await getTranslations('simulators.affordability');
