    ...
    return (
      <div className="space-y-4">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 h-10 rounded-lg bg-[#C9A961] hover:bg-[#B8985A] text-[#0A0A0A] font-medium text-sm transition"
        >
    ...
    <div className="space-y-5">
      <section className="rounded-2xl border border-[#C9A961]/30 bg-[#FAF8F3] p-5">
        <div className="flex items-start gap-4">
          <div className="size-12 rounded-xl bg-[#0A0A0A] text-[#C9A961] flex items-center justify-center shrink-0">
            <DatabaseBackup className="size-6" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm text-neutral-700">{t('dataNote')}</p>
        ...
        <button
          ...
          onClick={runBackup}
          disabled={pending}
          className="mt-4 inline-flex items-center gap-2 px-4 h-10 rounded-lg bg-[#C9A961] hover:bg-[#B8985A] disabled:opacity-60 text-[#0A0A0A] font-medium text-sm transition"
        >
          {pending ? (
      ...
      <section>
        ...
        {view.backups.length === 0 ? (
          <p className="text-sm text-neutral-400 py-4">{t('never')}</p>
        ) : (
          <ul className="rounded-xl border border-neutral-200 bg-white divide-y divide-neutral-100 overflow-hidden">
            {view.backups.map((b) => (
              ...
              >
                <FileJson className="size-4 text-[#C9A961] shrink-0" />
                <div className="flex-1 min-w-0">
