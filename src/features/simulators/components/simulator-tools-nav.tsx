...
import { GitCompareArrows, Layers, ReceiptText, TrendingUp, WalletCards } from 'lucide-react';
...
const TOOLS = [
  ...
  { segment: 'affordability', key: 'affordability', Icon: WalletCards },
  { segment: 'tax', key: 'tax', Icon: ReceiptText },
] as const;
