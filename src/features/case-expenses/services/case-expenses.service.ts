...
const EXPENSE_FULL_COLUMNS =
  'id, case_id, expense_date, amount, description, receipt_path, receipt_name, receipt_mime, receipt_drive_url, created_at, created_by, updated_at, updated_by, deleted_at, deleted_by' as const;
