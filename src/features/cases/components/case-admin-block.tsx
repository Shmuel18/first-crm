...
import { CaseAgreementAdminSection } from '@/features/agreements/components/case-agreement-admin-section';
...
export async function CaseAdminBlock({
  ...
  return (
    <CaseBlock title={t('blocks.admin')} icon={<Wallet />} fullWidth blockKey="admin">
      ...
      {/* הסכם התקשרות — signed / send-for-signature. Self-gates on
          view_collections like the collections section above. */}
      <CaseAgreementAdminSection caseId={caseId} />
